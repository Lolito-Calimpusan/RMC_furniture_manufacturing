...
<!-- container for products -->
    <div class="container-fluid bg-white mb-2">
        <h4 class="container pt-3">Orders History: 
            <span>
        ...
        <div class="row container m-auto p-2 px-5">
            <div class="table-responsive">
                ...
                <?php
                    ...
                    $stmt = $conn->prepare("SELECT * FROM approved_orders WHERE view = '0' AND user_id = ? ORDER BY id DESC");
                    ...
                    if($result->num_rows > 0){
                        ...
                        do{?>
                            ...
                            ?>
                            <table border="3" class="table table-bordered my-4" style="border: 2px solid black;">
                            <!-- box-shadow: 2px 4px 5px 2px rgba(0,0,0,0.3); width: 70%; -->
                                <tr>
                                    <td rowspan="5">
                        ...
                        echo '<h5 style="text-align: center;"> No Product(s) completed. </h5> ';
