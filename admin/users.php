...
<div class="card shadow">
  <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-dark">User Profile 
      ...
      <table class="table table-bordered text-dark text-center" id="dataTable"  cellspacing="0" style="box-shadow: 0px 2px 2px rgba(0,0,0,0.3);">
        ...
        <tbody>
          ...
          <?php
              require('../config.php');
              $i = 1;
              $stmt = $conn->prepare("SELECT * FROM register WHERE role = 'User' && status = 'show' ");
              $stmt->execute();
          ...
          <tr>
            ...
            <td style="width: 13px;">
                <!-- <form action="code.php" method="post">
                  ...
                  <button type="submit" name="delete_user" class="btn btn-danger"> <i class="fa fa-trash"></i></button>
                </form> -->
                <a href="code.php?delete_user=<?php echo $row['id']?>" onclick="return confirm('Are you sure you want to delete this user?');">
